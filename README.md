...
|-----------------|---|-----|------|-----|-------|
| Empirical 1     | 4 | 75  | 25   | 27  | 14    |
| Empirical 2     | 3 | 100 | 34   | 29  | 21    |
| Empirical 3     | 2 | 62  | 39   | 41  | 29    |
...
If A always makes the same eviction calls as S, then S is optimal as they will have the same miss count. Anytime A makes a different eviction than S, with the caches being the same until this point, we make a new schedule called A', that evicted the same item as S, but everything else is as it was in A. So lets say that S evicted 1 and A evicted 2, we would make A' in which it evicted 1. We must show that this new schedule A' has the same/less misses as the original A. 
